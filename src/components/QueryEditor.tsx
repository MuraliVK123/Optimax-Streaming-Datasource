...
export class QueryEditor extends PureComponent<Props> {
  ...
  constructor(instanceSettings: Props) {
    ...
    console.log("controller of query")
  ...
  render() {
    ...
    query.type = query.type ? query.type : "Log";
    query.cookieValue = document.cookie.split("=")[1]
          ...
          <div className="gf-form-group">
            ...
            <div className="gf-form">
              <label className="gf-form-label query-keyword width-10">Display Names</label>
               <div className="css-1so7yeh" style={displayNameStyle}>
               <div className="css-1kcogyo" style={displayNameStyle}>
